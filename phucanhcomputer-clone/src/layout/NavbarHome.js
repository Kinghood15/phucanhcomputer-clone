...
const NavBarHome = (props) =>{
    return(
        <Nav className="navbar-menu">
            <Menu className="menu">
                ...
                <ListDown className="ul list-down" id="list-down">
                    <li className="ItemProduct">
                        <Link to='/productcategory/6159fa47267b752d7ee4cb33'>
                    ...
                    <li className="ItemProduct">
                        <Link to='/productcategory/615b6dcdb2ee834c5cbb5ba3'>
            ...
            <ListNavRight className="ul list-nav-right">
                <li><Link to='./'><i className="far fa-check-circle"></i>100% Chính hãng</Link></li>
                <li><Link to='./'><i className="fas fa-hand-holding-usd"></i>Giá ưu đãi nhất</Link></li>
                <li><Link to='./'><i className="fas fa-truck"></i> Miễn phí vẫn chuyển</Link></li>                    
                <li><Link to='./'><i className="fas fa-check-circle"></i>Bảo hành nơi sử dụng</Link></li>
            </ListNavRight>
            <BoxDeal className="box-deal">
                <Link to='./'>Deal giờ vàng 
                    <span id="cont-total-deals"> 0 </span>
                </Link>    
            </BoxDeal>
        </Nav>
    );
